...
public class AIMovableDriver extends GameMovableDriverDefaultImpl {
    ...
    public SpeedVector getSpeedVector(Movable m) {
        ...
        while (true) {
            nbTries--;
            if ((possibleSpeedVector.getDirection().getX() == currentSpeedVector.getDirection().getX()) &&
                (possibleSpeedVector.getDirection().getY() != -currentSpeedVector.getDirection().getY()))
                break;
